...
- 2560×1440 at 143.991 Hz;
- `XRGB2101010` (10-bit), scale 1.6, color preset `wide`;
...
2. `lsusb`, `ethtool` and `fwupdmgr` are absent. This does not affect display quality. Installing `usbutils`, `ethtool` and `fwupd` would improve future observability, but no package installation was performed during this audit.
...
- Raw selected steady-state data: `runs/2026-09-08-steady-health.json`
- Human-readable steady-state result: `runs/2026-09-08-steady-health.md`
