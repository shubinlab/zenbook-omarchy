...
| Omarchy | `4.0.3rc1-2` | Stock commands, defaults, migrations and package policy |
...
| Session audio | PipeWire `1.6.8`, WirePlumber `0.5.17` | ALSA devices, HDMI audio and voice processing |
...
rule, monitor telemetry, voice echo cancellation, a terminal extension,
diagnostic packages and a ChatGPT binding. It retains Omarchy's stock
