...
| Bitwarden | [bitwarden/apply.sh](../../profiles/zenbook-um3406ka/bitwarden/apply.sh), [launcher](../../profiles/zenbook-um3406ka/bitwarden/launcher), [onboard.sh](../../profiles/zenbook-um3406ka/bitwarden/onboard.sh) and [doctor.sh](../../profiles/zenbook-um3406ka/bitwarden/doctor.sh) | Final optional stage of the full bootstrap; also `scripts/install-bitwarden.sh` or `--stage bitwarden` | `scripts/doctor.sh --profile zenbook-um3406ka` | `bitwarden/apply.sh --rollback`; backup under `~/.local/state/omarchy-profiles/backups/bitwarden/` |
