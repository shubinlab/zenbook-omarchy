...
| Bitwarden | [bitwarden/apply.sh](../../profiles/zenbook-um3406ka/bitwarden/apply.sh), [launcher](../../profiles/zenbook-um3406ka/bitwarden/launcher) and [doctor.sh](../../profiles/zenbook-um3406ka/bitwarden/doctor.sh) | `scripts/install-bitwarden.sh` or bootstrap `--stage bitwarden` | `scripts/doctor.sh --profile zenbook-um3406ka` | `bitwarden/apply.sh --rollback`; backup under `~/.local/state/omarchy-profiles/backups/bitwarden/` |
