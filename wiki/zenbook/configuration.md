...
| Voice | Native Omarchy installer plus `voice/apply.sh`; Lemonade FLM NPU model | Bootstrap, or `voice/apply.sh --apply` for an existing native install | `voice/apply.sh --check`, `voice/doctor.sh` | `voice/apply.sh --rollback`; legacy migration is separate |
